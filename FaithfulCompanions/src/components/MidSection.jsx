...
const Midsection = () => {
  ...
  return (
    ...
    <h1 className="custom-midsection-mainheading fw-bold">Welcome To Faithful Companions Market</h1>
      <h1 className="custom-midsection-heading fw-bold" data-aos="fade-left">
        Paws, Claws, Fins, & Feathers: 
        <br/>Everything for Your Furry Friends!
      </h1>
      <Container className="p-4 text-center mb-3 custom-midsection-border1" data-aos="fade-right">
